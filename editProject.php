...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content">
      ...
      <h1 class="h3 text-gray-800">Edit Project</h1>
      <hr>
      ...
      <form action = "saveProject.php" method="POST">
          ...
          <input type="hidden" name="id_to_edit" value = "<?php echo $id?>">
              ...
              <div class = "row mb-3 justify-content-center">
                  ...
                  <div class = "col-sm-6">
                    ...
                    <input class="form-control" name="name" type="text" value="<?php echo $project['name']?>">
                  </div>
              ...
              <div class = "row mb-3">
                ...
                <?php 
                  ...
                  if(in_array($user['username'],$devArray)){
              ...
              <div class = "row mb-3">
                ...
                <textarea class="form-control" name="description" rows="3"><?php echo $project['description']?></textarea>
          ...
          <div class="modal-footer">
            ...
            <button type="submit" name= "saveProject" class="btn btn-primary" value="saveProject">Save</button>
          </div>
